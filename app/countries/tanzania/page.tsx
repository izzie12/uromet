...
import Form from '~/components/common/Form';
  ...
  const contactData: ContactProps = {
    ...
    header: {
        title: 'Get in Touch',
        subtitle: 'Our team in Tanzania would love to hear from you!',
        highlight: 'Tanzania',
    },
    content:
        '',
    items: [
        {
            title: 'Our Address',
            description: ['P.O. Box 6561 Dar Es Salaam Uromet Tanzania'],
            icon: IconMapPin,
        },
        {
            title: 'Contact',
            description: ['Mobile: +255 748 606969 ', 'Mail: smbenna@hotmail.com'],
            icon: IconPhoneCall,
        },
        {
            title: 'Working hours',
